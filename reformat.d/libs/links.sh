...
function links(){
  ...
  gsed -i 's|(#transport_and_format.asciidoc#transport_and_format_response_format)|(https://ocpi.dev)|g' "$file"
  ...
  gsed -i 's|(#types_string_type)|(https://ocpi.dev)|g' "$file"
  gsed -i 's|(#types_number_type)|(https://ocpi.dev)|g' "$file"
