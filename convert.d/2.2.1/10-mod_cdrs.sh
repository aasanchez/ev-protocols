...
function fix_mod_cdrs() {
  file="$ROOT/website/docs/ocpi/10-mod_cdrs.md"
  tempfile="$file.tmp"
...
function flavored_mod_cdrs() {
  ...
  rm -rf "$ROOT/website/docs/ocpi/06-modules/05-cdrs"
  mkdir -p "$ROOT/website/docs/ocpi/06-modules/05-cdrs"
...
E_O_HEADERS
  ...
  rm -rf "$ROOT/website/docs/ocpi/10-mod_cdrs.md"
}