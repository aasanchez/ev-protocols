...
| start_date_time            | [DateTime](/07-types/01-intro.md#datetime-type)                             | 1     | Start timestamp of the charging session, or in-case of a reservation (before the start of a session) the start of the reservation.                                                                                                                                                                                                                                                                                                                                                         |
...
| auth_method                | [AuthMethod](/06-modules/05-cdrs/07-data-types.md#authmethod-enum)          | 1     | Method used for authentication. Multiple \<mod_cdrs_authmethod_enum,AuthMethods\>\> are possible during a charging sessions, for example when the session was started with a reservation: [ReserveNow](https://ocpi.dev): [`COMMAND`](/06-modules/05-cdrs/07-data-types.md#authmethod-enum). When the driver arrives and starts charging using a Token that is whitelisted: [`WHITELIST`](/06-modules/05-cdrs/07-data-types.md#authmethod-enum). The last method SHALL be used in the CDR. |
...
| cdr_location               | [CdrLocation](/06-modules/05-cdrs/07-data-types.md#cdrlocation-class)       | 1     | Location where the charging session took place, including only the relevant [EVSE](https://ocpi.dev) and [Connector](https://ocpi.dev).                                                                                                                                                                                                                                                                                                                                                    |
| meter_id                   | [string](/07-types/01-intro.md#string-type)(255)                            | ?     | Identification of the Meter inside the Charge Point.                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| currency                   | [string](/07-types/01-intro.md#string-type)(3)                              | 1     | Currency of the CDR in ISO 4217 Code.                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| total_time                 | [number](/07-types/01-intro.md#number-type)                                 | 1     | Total duration of the charging session (including the duration of charging and not charging), in hours.                                                                                                                                                                                                                                                                                                                                                                                    |
...
| credit_reference_id        | [CiString](/07-types/01-intro.md#cistring-type)(39)                         | ?     | Is required to be set for a Credit CDR. This SHALL contain the `id` of the CDR for which this is a Credit CDR.                                                                                                                                                                                                                                                                                                                                                                             |
