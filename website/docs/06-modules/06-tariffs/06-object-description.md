...
See: [Free of Charge Tariff example](/06-modules/06-tariffs/06-object-description.md#free-of-charge-tariff-example)
...
| type            | [TariffType](/06-modules/06-tariffs/07-data-types.md#tarifftype-enum)        | ?     | Defines the type of the tariff. This allows for distinction in case of given [Charging Preferences](/06-modules/04-sessions/06-object-description.md#set-charging-preferences). When omitted, this tariff is valid for all sessions.                                                                                                                                                                                       |
...
| elements        | [TariffElement](/06-modules/06-tariffs/07-data-types.md#tariffelement-class) | \+    | List of Tariff Elements.                                                                                                                                                                                                                                                                                                                                                                                                   |
