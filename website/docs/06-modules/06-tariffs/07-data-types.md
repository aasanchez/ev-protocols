...
|-----------|-----------------------------------------------------------------------------------------|-------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| type      | [TariffDimensionType](/06-modules/06-tariffs/07-data-types.md#tariffdimensiontype-enum) | 1     | The dimension that is being priced                                                                                                                                                                                                                                                                                                                                                                                        |
...
| Property         | Type                                                                                   | Card. | Description                                                                                             |
|------------------|----------------------------------------------------------------------------------------|-------|---------------------------------------------------------------------------------------------------------|
| price_components | [PriceComponent](/06-modules/06-tariffs/07-data-types.md#pricecomponent-class)         | \+    | List of Price Components that each describe how a certain dimension is priced.                          |
| restrictions     | [TariffRestrictions](/06-modules/06-tariffs/07-data-types.md#tariffrestrictions-class) | ?     | Restrictions that describe under which circumstances the Price Components of this Tariff Element apply. |
...
| TIME         | Time charging: defined in hours, `step_size` multiplier: 1 second Can also be used in combination with a [RESERVATION](/06-modules/06-tariffs/07-data-types.md#tariffrestrictions-class) restriction to describe the price of the reservation time. |
...
| day_of_week  | [DayOfWeek](/06-modules/06-tariffs/07-data-types.md#dayofweek-enum)                                   | \*    | Which day(s) of the week this TariffElement is active.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| reservation  | [ReservationRestrictionType](/06-modules/06-tariffs/07-data-types.md#reservationrestrictiontype-enum) | ?     | When this field is present, the TariffElement describes reservation costs. A reservation starts when the reservation is made, and ends when the driver starts charging on the reserved EVSE/Location, or when the reservation expires. A reservation can only have: [FLAT](/06-modules/06-tariffs/07-data-types.md#tariffdimensiontype-enum) and [TIME](/06-modules/06-tariffs/07-data-types.md#tariffdimensiontype-enum) TariffDimensions, where `TIME` is for the duration of the reservation.                                                                                                                 |
...
| PROFILE_CHEAP  | Used to describe that a Tariff is valid when [Charging Preference](/06-modules/04-sessions/06-object-description.md#set-charging-preferences): [CHEAP](/06-modules/04-sessions/07-data-types.md#profiletype-enum) is set for the session.                                                           |
| PROFILE_FAST   | Used to describe that a Tariff is valid when [Charging Preference](/06-modules/04-sessions/06-object-description.md#set-charging-preferences): [FAST](/06-modules/04-sessions/07-data-types.md#profiletype-enum) is set for the session.                                                            |
| PROFILE_GREEN  | Used to describe that a Tariff is valid when [Charging Preference](/06-modules/04-sessions/06-object-description.md#set-charging-preferences): [GREEN](/06-modules/04-sessions/07-data-types.md#profiletype-enum) is set for the session.                                                           |
