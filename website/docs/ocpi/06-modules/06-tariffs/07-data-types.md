...
| max_kwh      | [number](/docs/ocpi/07-types/01-intro.md#number-type)                                                           | ?     | Maximum consumed energy in kWh, for example 50, valid until this amount of energy (exclusive) being used.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
