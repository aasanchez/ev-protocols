...
only does an [realtime authorization](/ocpi/06-modules/07-tokens/04-flow-and-lifecycle.md#real-time-authorization) when
the OCPP Authorize request is for an RFID Token and the START_SESSION for this Token was received more then 15 minutes
ago.
