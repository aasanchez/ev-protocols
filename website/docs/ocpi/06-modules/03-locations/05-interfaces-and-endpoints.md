...
interface](/ocpi/06-modules/03-locations/05-interfaces-and-endpoints.md#get-object-request-parameters) to retrieve a
specific Location, EVSE or Connector. This feature might be used by an Receiver that wants information about a specific
Location, but has not implemented the Receiver Locations interface (i.e. cannot receive Push).
...
| Method                                                                         | Description |
|--------------------------------------------------------------------------------|-------------|
| [GET](/ocpi/06-modules/03-locations/05-interfaces-and-endpoints.md#get-method) |             |
| POST                                                                           | n/a         |
| PUT                                                                            | n/a         |
| PATCH                                                                          | n/a         |
| DELETE                                                                         | n/a         |
...
List](/ocpi/06-modules/03-locations/05-interfaces-and-endpoints.md#get-list-request-parameters)) or it can be used to
retrieve information about one specific Location, EVSE or Connector ([GET
Object](/ocpi/06-modules/03-locations/05-interfaces-and-endpoints.md#get-object-request-parameters)).
...
|-----------|------------------------------------------------------|----------|-----------------------------------------------------------------------------------------------------|
| date_from | [DateTime](/ocpi/07-types/01-intro.md#datetime-type) | no       | Only return Locations that have `last_updated` after or equal to this Date/Time (inclusive).        |
| date_to   | [DateTime](/ocpi/07-types/01-intro.md#datetime-type) | no       | Only return Locations that have `last_updated` up to this Date/Time, but not including (exclusive). |
...
|------------------------------------------------------------------------------------|-------|-----------------------------------------|
| [Location](/ocpi/06-modules/03-locations/06-object-description.md#location-object) | \*    | List of all Locations with valid EVSEs. |
...
| Parameter    | Datatype                                                 | Required | Description                                                     |
|--------------|----------------------------------------------------------|----------|-----------------------------------------------------------------|
| location_id  | [CiString](/ocpi/07-types/01-intro.md#cistring-type)(36) | yes      | Location.id of the Location object to retrieve.                 |
| evse_uid     | [CiString](/ocpi/07-types/01-intro.md#cistring-type)(36) | no       | Evse.uid, required when requesting an EVSE or Connector object. |
| connector_id | [CiString](/ocpi/07-types/01-intro.md#cistring-type)(36) | no       | Connector.id, required when requesting a Connector object.      |
...
| Type                                                                                 | Card. | Description                                                |
|--------------------------------------------------------------------------------------|-------|------------------------------------------------------------|
| [Location](/ocpi/06-modules/03-locations/06-object-description.md#location-object)   | 1     | If a Location object was requested: the Location object.   |
| [EVSE](/ocpi/06-modules/03-locations/06-object-description.md#evse-object)           | 1     | If an EVSE object was requested: the EVSE object.          |
| [Connector](/ocpi/06-modules/03-locations/06-object-description.md#connector-object) | 1     | If a Connector object was requested: the Connector object. |
...
Objects](/ocpi/04-transport-and-format/01-json-http-implementation-guide.md#client-owned-object-push), so the end-points
need to contain the required extra fields:
{[party_id](/ocpi/06-modules/02-credentials/06-object-description.md#credentials-object)} and
{[country_code](/ocpi/06-modules/02-credentials/06-object-description.md#credentials-object)}.
...
| Method                                                                             | Description                                                                                                                                                                                                                     |
|------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [GET](/ocpi/06-modules/03-locations/05-interfaces-and-endpoints.md#get-method-1)   | Retrieve a Location as it is stored in the eMSP system.                                                                                                                                                                         |
| POST                                                                               | n/a *(use [PUT](/ocpi/06-modules/03-locations/05-interfaces-and-endpoints.md#put-method))*                                                                                                                                      |
| [PUT](/ocpi/06-modules/03-locations/05-interfaces-and-endpoints.md#put-method)     | Push new/updated Location, EVSE and/or Connector to the eMSP.                                                                                                                                                                   |
| [PATCH](/ocpi/06-modules/03-locations/05-interfaces-and-endpoints.md#patch-method) | Notify the eMSP of partial updates to a Location, EVSE or Connector (such as the status).                                                                                                                                       |
| DELETE                                                                             | n/a *(use [PATCH](/ocpi/06-modules/03-locations/05-interfaces-and-endpoints.md#patch-method) to update the `status` to `REMOVED` as described in [Flow and Lifecycle](/ocpi/06-modules/03-locations/04-flow-and-lifecycle.md))* |
...
eMSP via a [PUT](/ocpi/06-modules/03-locations/05-interfaces-and-endpoints.md#put-method) or
[PATCH](/ocpi/06-modules/03-locations/05-interfaces-and-endpoints.md#patch-method) call.
...
| Parameter    | Datatype                                                 | Required | Description                                                             |
|--------------|----------------------------------------------------------|----------|-------------------------------------------------------------------------|
| country_code | [CiString](/ocpi/07-types/01-intro.md#cistring-type)(2)  | yes      | Country code of the CPO requesting data from the eMSP system.           |
| party_id     | [CiString](/ocpi/07-types/01-intro.md#cistring-type)(3)  | yes      | Party ID (Provider ID) of the CPO requesting data from the eMSP system. |
| location_id  | [CiString](/ocpi/07-types/01-intro.md#cistring-type)(36) | yes      | Location.id of the Location object to retrieve.                         |
| evse_uid     | [CiString](/ocpi/07-types/01-intro.md#cistring-type)(36) | no       | Evse.uid, required when requesting an EVSE or Connector object.         |
| connector_id | [CiString](/ocpi/07-types/01-intro.md#cistring-type)(36) | no       | Connector.id, required when requesting a Connector object.              |
...
When the PUT only contains a [Connector](/ocpi/06-modules/03-locations/06-object-description.md#connector-object)
Object, the Receiver SHALL also set the new `last_updated` value on the parent
[EVSE](/ocpi/06-modules/03-locations/06-object-description.md#evse-object) and
[Location](/ocpi/06-modules/03-locations/06-object-description.md#location-object) Objects.

When the PUT only contains a [EVSE](/ocpi/06-modules/03-locations/06-object-description.md#evse-object) Object, the
Receiver SHALL also set the new `last_updated` value on the parent
[Location](/ocpi/06-modules/03-locations/06-object-description.md#location-object) Object.
...
{[party_id](/ocpi/06-modules/02-credentials/06-object-description.md#credentials-object)} and
{[country_code](/ocpi/06-modules/02-credentials/06-object-description.md#credentials-object)} have to be included in the
URL (as URL segments, as described in the [Receiver
Interface](/ocpi/06-modules/03-locations/05-interfaces-and-endpoints.md#receiver-interface)).

| Parameter    | Datatype                                                 | Required | Description                                                                                                                                                   |
|--------------|----------------------------------------------------------|----------|---------------------------------------------------------------------------------------------------------------------------------------------------------------|
| country_code | [CiString](/ocpi/07-types/01-intro.md#cistring-type)(2)  | yes      | Country code of the CPO requesting this PUT to the eMSP system. This SHALL be the same value as the `country_code` in the Location object being pushed.       |
| party_id     | [CiString](/ocpi/07-types/01-intro.md#cistring-type)(3)  | yes      | Party ID (Provider ID) of the CPO requesting this PUT to the eMSP system. This SHALL be the same value as the `party_id` in the Location object being pushed. |
| location_id  | [CiString](/ocpi/07-types/01-intro.md#cistring-type)(36) | yes      | Location.id of the new Location object, or the Location of which an EVSE or Connector object is pushed.                                                       |
| evse_uid     | [CiString](/ocpi/07-types/01-intro.md#cistring-type)(36) | no       | Evse.uid, required when an EVSE or Connector object is pushed.                                                                                                |
| connector_id | [CiString](/ocpi/07-types/01-intro.md#cistring-type)(36) | no       | Connector.id, required when a Connector object is pushed.                                                                                                     |

#### Request Body

The request body contains the new/updated object.

When the PUT contains a [Connector](/ocpi/06-modules/03-locations/06-object-description.md#connector-object) Object, the
Receiver SHALL also set the new `last_updated` value on the parent
[EVSE](/ocpi/06-modules/03-locations/06-object-description.md#evse-object) and
[Location](/ocpi/06-modules/03-locations/06-object-description.md#location-object) Objects.

When the PUT contains a [EVSE](/ocpi/06-modules/03-locations/06-object-description.md#evse-object) Object, the Receiver
SHALL also set the new `last_updated` value on the parent
[Location](/ocpi/06-modules/03-locations/06-object-description.md#location-object) Object.

| Type                                                                                 | Card. | Description                                           |
|--------------------------------------------------------------------------------------|-------|-------------------------------------------------------|
| [Location](/ocpi/06-modules/03-locations/06-object-description.md#location-object)   | 1     | New Location object, or Location object to replace.   |
| [EVSE](/ocpi/06-modules/03-locations/06-object-description.md#evse-object)           | 1     | New EVSE object, or EVSE object to replace.           |
| [Connector](/ocpi/06-modules/03-locations/06-object-description.md#connector-object) | 1     | New Connector object, or Connector object to replace. |
...
Same as the [PUT](/ocpi/06-modules/03-locations/05-interfaces-and-endpoints.md#put-method) method, but only the
...
When the PATCH is on a [Connector](/ocpi/06-modules/03-locations/06-object-description.md#connector-object) Object, the
Receiver SHALL also set the new `last_updated` value on the parent
[EVSE](/ocpi/06-modules/03-locations/06-object-description.md#evse-object) and
[Location](/ocpi/06-modules/03-locations/06-object-description.md#location-object) Objects.

When the PATCH is on a [EVSE](/ocpi/06-modules/03-locations/06-object-description.md#evse-object) Object, the Receiver
SHALL also set the new `last_updated` value on the parent
[Location](/ocpi/06-modules/03-locations/06-object-description.md#location-object) Object.
