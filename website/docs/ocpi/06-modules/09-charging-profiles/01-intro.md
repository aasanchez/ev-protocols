...
**Module dependency:** [Sessions module](/ocpi/06-modules/04-sessions/01-intro.md)
...
[Session](/ocpi/06-modules/04-sessions/06-object-description.md#session-object) Objects to the SCSP. the SCSP can act on
the received/updated [Session](/ocpi/06-modules/04-sessions/06-object-description.md#session-object) Objects, by sending
Charging Profile commands via the eMSP to the CPO.
...
The CPO can forward OCPI [Session](/ocpi/06-modules/04-sessions/06-object-description.md#session-object) Objects to the
SCSP. the SCSP can act on the received/updated
[Session](/ocpi/06-modules/04-sessions/06-object-description.md#session-object) Objects, by sending Charging Profile
commands to the CPO.
