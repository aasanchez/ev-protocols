...
tokens*](/docs/ocpi/06-modules/02-credentials/06-object-description.md#credentials-object) are exchanged via the
[credentials module](/docs/ocpi/06-modules/02-credentials/01-intro.md). These are different *tokens* than the
[Tokens](/docs/ocpi/06-modules/07-tokens/06-object-description.md#token-object) exchanged via the [Token
Module](/docs/ocpi/06-modules/07-tokens/01-intro.md): Tokens used by drivers to authorize charging. To prevent
...
[`CREDENTIALS_TOKEN_A`](/docs/ocpi/06-modules/02-credentials/03-use-cases.md#registration), on another module than:
[`credentials`](/docs/ocpi/06-modules/02-credentials/01-intro.md) or
[`versions`](/docs/ocpi/06-modules/01-versions/01-intro.md), the server SHALL respond with an HTTP `401 * Unauthorized`
status code.
...
[GET](/docs/ocpi/04-transport-and-format/01-json-http-implementation-guide.md#get-method), POST,
[PUT](/docs/ocpi/04-transport-and-format/01-json-http-implementation-guide.md#put-method),
[PATCH](/docs/ocpi/04-transport-and-format/01-json-http-implementation-guide.md#patch-method) or DELETE. The OCPI
protocol uses them in a way similar to REST APIs.

| Method                                                                                        | Description                                        |
|-----------------------------------------------------------------------------------------------|----------------------------------------------------|
| [GET](/docs/ocpi/04-transport-and-format/01-json-http-implementation-guide.md#get-method)     | Fetches objects or information.                    |
| POST                                                                                          | Creates new objects or information.                |
| [PUT](/docs/ocpi/04-transport-and-format/01-json-http-implementation-guide.md#put-method)     | Updates existing objects or information.           |
| [PATCH](/docs/ocpi/04-transport-and-format/01-json-http-implementation-guide.md#patch-method) | Partially updates existing objects or information. |
...
|-----------|-----------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| date_from | [DateTime](/docs/ocpi/07-types/01-intro.md#datetime-type) | Only return objects that have `last_updated` after or equal to this Date/Time (inclusive).                                                                                                                                                              |
| date_to   | [DateTime](/docs/ocpi/07-types/01-intro.md#datetime-type) | Only return objects that have `last_updated` up to this Date/Time, but not including (exclusive).                                                                                                                                                       |
...
[GET](/docs/ocpi/04-transport-and-format/01-json-http-implementation-guide.md#get-method) method to check the state of
the object in the other party's system. If the object doesn't exist, the client should do a
[PUT](/docs/ocpi/04-transport-and-format/01-json-http-implementation-guide.md#put-method).
...
{[country_code](/docs/ocpi/06-modules/02-credentials/06-object-description.md#credentials-object)} and
{[party_id](/docs/ocpi/06-modules/02-credentials/06-object-description.md#credentials-object)}. The
[country_code's](/docs/ocpi/06-modules/02-credentials/06-object-description.md#credentials-object) and
[party_id's](/docs/ocpi/06-modules/02-credentials/06-object-description.md#credentials-object) of the parties on the
other platform are received during the [credentials](/docs/ocpi/06-modules/02-credentials/01-intro.md) handshake in the
[CredentialsRoles](/docs/ocpi/06-modules/02-credentials/07-data-types.md#credentialsrole-class). The roles exchanged
during the [credentials](/docs/ocpi/06-modules/02-credentials/01-intro.md) handshake provide the server with details
needed to determine which URLs a client might use.
...
[country_code](/docs/ocpi/06-modules/02-credentials/06-object-description.md#credentials-object) and/or
[party_id](/docs/ocpi/06-modules/02-credentials/06-object-description.md#credentials-object) than one of the
[CredentialsRoles](/docs/ocpi/06-modules/02-credentials/07-data-types.md#credentialsrole-class) given during the
[credentials](/docs/ocpi/06-modules/02-credentials/01-intro.md) handshake, it is allowed to respond with an HTTP `404`
...
{[country_code](/docs/ocpi/06-modules/02-credentials/06-object-description.md#credentials-object)} and
{[party_id](/docs/ocpi/06-modules/02-credentials/06-object-description.md#credentials-object)} in the object itself.

When one or more objects, returned in the response, do not meet one of the
[CredentialsRoles](/docs/ocpi/06-modules/02-credentials/07-data-types.md#credentialsrole-class) given during the
[credentials](/docs/ocpi/06-modules/02-credentials/01-intro.md) handshake, these objects may be ignored.
...
Request](/docs/ocpi/04-transport-and-format/01-json-http-implementation-guide.md#open-routing-request)

Only requests/responses from Function Modules: such as: [Tokens](/docs/ocpi/06-modules/07-tokens/01-intro.md),
[Locations](/docs/ocpi/06-modules/03-locations/01-intro.md), [CDRs](/docs/ocpi/06-modules/05-cdrs/01-intro.md) etc.
SHALL be routed, so need the routing headers.

The requests/responses to/from Configuration Modules: [Credentials](/docs/ocpi/06-modules/02-credentials/01-intro.md),
[Versions](/docs/ocpi/06-modules/01-versions/01-intro.md) and [Hub Client
Info](/docs/ocpi/06-modules/10-hubclientinfo/01-intro.md) are not to be routed, and are for Platform-to-Platform or
Platform-to-Hub communication. Thus routing headers SHALL NOT be used with these modules.

| HTTP Header            | Datatype                                                     | Description                                                          |
|------------------------|--------------------------------------------------------------|----------------------------------------------------------------------|
| OCPI-to-party-id       | [CiString](/docs/ocpi/07-types/01-intro.md#cistring-type)(3) | *party id* of the connected party this message is to be sent to.     |
| OCPI-to-country-code   | [CiString](/docs/ocpi/07-types/01-intro.md#cistring-type)(2) | *country code* of the connected party this message is to be sent to. |
| OCPI-from-party-id     | [CiString](/docs/ocpi/07-types/01-intro.md#cistring-type)(3) | *party id* of the connected party this message is sent from.         |
| OCPI-from-country-code | [CiString](/docs/ocpi/07-types/01-intro.md#cistring-type)(2) | *country code* of the connected party this message is sent from.     |
...
Request](/docs/ocpi/04-transport-and-format/01-json-http-implementation-guide.md#open-routing-request) MUST be used.
(see below)

Broadcast Push SHALL only be used with information that is meant to be sent to all other parties. It is useful to share
data like [Tokens](/docs/ocpi/06-modules/07-tokens/01-intro.md) and
[Locations](/docs/ocpi/06-modules/03-locations/01-intro.md), but not so much for
[CDRs](/docs/ocpi/06-modules/05-cdrs/01-intro.md) and [Sessions](/docs/ocpi/06-modules/04-sessions/01-intro.md) as these
pieces of information are specific to only one party and are possibly even protected by GDPR or other laws.
...
Push](/docs/ocpi/04-transport-and-format/01-json-http-implementation-guide.md#broadcast-push) though, as [Broadcast
Push](/docs/ocpi/04-transport-and-format/01-json-http-implementation-guide.md#broadcast-push) only works for the [Push
model](/docs/ocpi/04-transport-and-format/01-json-http-implementation-guide.md#pull-and-push), not for
[GET](/docs/ocpi/04-transport-and-format/01-json-http-implementation-guide.md#get-method) requests.

Open Routing Requests are possible for GET ([Not GET
ALL](/docs/ocpi/04-transport-and-format/01-json-http-implementation-guide.md#get-all-via-hubs)), POST, PUT, PATCH and
DELETE.
...
[Broadcast Push](/docs/ocpi/04-transport-and-format/01-json-http-implementation-guide.md#broadcast-push) to the Hub.
...
itself](/docs/ocpi/04-transport-and-format/01-json-http-implementation-guide.md#open-routing-request). For an Open
Routing Request, the TO headers in the request from the requesting party to the Hub MUST be omitted.
...
Hub](/docs/ocpi/04-transport-and-format/01-json-http-implementation-guide.md#get-all-via-hubs). For a GET All via Hub:
The HTTP Method SHALL be GET, The call is to a Senders Interface, the TO headers in the request to the Hub has to be set
to the Hub.
